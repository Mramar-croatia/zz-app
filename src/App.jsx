...
function App() {
  ...
  return (
    ...
    >
      {error ? (
        <div className="card p-10 text-center border-[#FECDD3] bg-[#FFF1F2]">
          <div className="text-[#991B1B] mb-5">
          ...
          <h3 className="font-bold text-surface-900 mb-2 tracking-tight">Greška pri učitavanju podataka</h3>
          <p className="text-surface-500 mb-5 text-sm">{error.message}</p>
          <button
            onClick={refetchAll}
